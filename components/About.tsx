        ...
        <div className="w-full bottom-10 mt-10 font-extrabold">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 max-md:text-center">
                ...
                <div className="w-full">
                    <h3 className="text-xl">Hello! I&apos;m Idris Roti</h3>
                    <p className="opacity-50 w-[90%] max-md:mx-auto md:w-full lg:w-2/3">Frontend developer leveraging the power of code and design to create seamless, user-focused online experiences.</p>
                </div>
            </div>
            <div className="h-[1px] my-5 bg-black/10"/>
